...
/* Analyse the yearly performance of the products by comparing their sales
   to both average sales performance of the products and the previous year's sales*/
...
SELECT 
	...
	current_sales - LAG(current_sales,1) OVER( PARTITION BY product_name ORDER BY order_year) AS diff_pre_year,
	CASE
